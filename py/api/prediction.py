...
class ElementPredictionResponse(BaseModel):
    class Result(BaseModel):
        ...
        element: ElementDescription = None
...
class Prediction:
    ...
    def wait(self, client: Client):
        ...
        active_statuses = {'submitted', 'processing', 'pending', 'queued', 'running'}
        while self._task_info is None or self._task_info.task_status in active_statuses:
